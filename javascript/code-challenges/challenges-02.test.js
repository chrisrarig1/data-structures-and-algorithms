...
const addOne = (arr) => {
  let newArray = arr.map(ele => ele + 1);
  return newArray;
};
...
const mapTwoToThe = (arr) => {
  let newArray = arr.map(ele => Math.pow(2 ,ele));
  return newArray;
};
